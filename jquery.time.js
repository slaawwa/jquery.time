$(function() {
    ...
    var now = new Date(), 
        ...
        opt = {
            ...
            refresh: function() {
                t = new Date();
                opt.now = t.getTime() + opt.serverDefTime;
    ...
    var _helper = {
        ...
        setting: function(opts, data) {
            var ar = $.extend({
                withAt: false,
                time: new Date().getTime() + opt.serverDefTime,
                showPast: true,
                showFuture: true,
                futureLabel: '',
                pastLabel: '',
    ...
    var methods = {
        ...
        getServerTime: function(onlyDef) {
            return methods.get('serverDefTime') + (onlyDef? 0: new Date().getTime());
        },
